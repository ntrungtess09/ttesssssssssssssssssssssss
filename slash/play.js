...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .setDescriptionLocalizations({
            pl: 'Phát một bài hát hoặc danh sách phát từ YouTube hoặc Spotify'
        })
        .addStringOption((option) => option
            .setName("insert")
            .setDescription("Provide link or essential keywords")
            .setDescriptionLocalizations({
                pl: 'Nhập link hoặc từ khóa cần thiết'
            })
            .setRequired(true)),
    ...
    run: async ({ client, interaction }) => {
        ...
        // Handling YOUTUBE PLAYLIST
	        ...
	        .setFooter('© Developer: NTrungTess | XLTG' , client.user.avatarURL)
        }
